...
IGNORED_MODS = [0, X.Mod2Mask, X.LockMask, X.Mod2Mask | X.LockMask]

for mod in IGNORED_MODS:
    dpy.screen().root.grab_key(dpy.keysym_to_keycode(XK.string_to_keysym("F1")), X.Mod1Mask | mod, 1,
            X.GrabModeAsync, X.GrabModeAsync)
    dpy.screen().root.grab_button(1, X.Mod1Mask | mod, 1, X.ButtonPressMask|X.ButtonReleaseMask|X.PointerMotionMask,
            X.GrabModeAsync, X.GrabModeAsync, X.NONE, X.NONE)
    dpy.screen().root.grab_button(3, X.Mod1Mask | mod, 1, X.ButtonPressMask|X.ButtonReleaseMask|X.PointerMotionMask,
            X.GrabModeAsync, X.GrabModeAsync, X.NONE, X.NONE)
